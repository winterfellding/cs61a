...
def div_interval(x, y):
    ...
    """
    "*** YOUR CODE HERE ***"
    assert upper_bound(y) != 0 and lower_bound(y) != 0, "y can not be zero"
...
def quadratic(x, a, b, c):
    ...
    """
    "*** YOUR CODE HERE ***"
    return div_interval(sub_interval(interval(0, 0), interval(b, 1)), mul_interval(interval(2, 1), interval(a, 1)))
